...
head(date_data)
date_data<-date_data<-stri_replace_all_fixed(date_data, "\r","")
date_data<-date_data<-stri_replace_all_fixed(date_data, "\n","")
date_data<-date_data<-stri_replace_all_fixed(date_data, "\t","")
date_data<-date_data<-stri_replace_all_fixed(date_data, "【浏览本版】","")
...
head(body_data)
tail(body_data)
body_data<-date_data<-stri_replace_all_fixed(body_data, "\r","")
body_data<-date_data<-stri_replace_all_fixed(body_data, "\n","")
body_data<-date_data<-stri_replace_all_fixed(body_data, "\t","")
